    ...
    public static async Task<IApplicationBuilder> SeedDatabaseAsync(this IApplicationBuilder app)
    {
        ...
        try
        {
            ...
            if (dbProvider != null && dbProvider.Contains("MySql"))
            {
                ...
                // 10-Stage Pipeline Entity Tables
                try { await context.Database.ExecuteSqlRawAsync(@"CREATE TABLE IF NOT EXISTS AdmissibilityAssessments (Id VARCHAR(36) NOT NULL PRIMARY KEY, CaseId VARCHAR(36) NOT NULL, IsNotAnonymous TINYINT(1) NOT NULL DEFAULT 1, IsNotInCourt TINYINT(1) NOT NULL DEFAULT 1, IsWithinMandate TINYINT(1) NOT NULL DEFAULT 1, HasSupportingDocuments TINYINT(1) NOT NULL DEFAULT 1, HasExhaustedInternalProcedures TINYINT(1) NOT NULL DEFAULT 1, IsAdmissible TINYINT(1) NOT NULL DEFAULT 1, ScreeningNotes TEXT NULL, RejectionReason TEXT NULL, AssessedByUserId VARCHAR(36) NOT NULL, AssessedAt DATETIME(6) NOT NULL, CreatedAt DATETIME(6) NOT NULL, LastModifiedAt DATETIME(6) NULL, CreatedByUserId VARCHAR(36) NULL, LastModifiedByUserId VARCHAR(36) NULL, IsDeleted TINYINT(1) NOT NULL DEFAULT 0, DeletedAt DATETIME(6) NULL, CONSTRAINT FK_AdmissibilityAssessments_Cases_CaseId FOREIGN KEY (CaseId) REFERENCES Cases (Id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"); } catch { }
                try { await context.Database.ExecuteSqlRawAsync(@"CREATE TABLE IF NOT EXISTS MediationLogs (Id VARCHAR(36) NOT NULL PRIMARY KEY, CaseId VARCHAR(36) NOT NULL, SessionDate DATETIME(6) NOT NULL, Attendees TEXT NOT NULL, SummaryOfDiscussions TEXT NOT NULL, SettlementProposal TEXT NULL, IsAmicablySettled TINYINT(1) NOT NULL DEFAULT 1, AgreementDocumentUrl VARCHAR(500) NULL, LoggedByUserId VARCHAR(36) NOT NULL, LoggedAt DATETIME(6) NOT NULL, CreatedAt DATETIME(6) NOT NULL, LastModifiedAt DATETIME(6) NULL, CreatedByUserId VARCHAR(36) NULL, LastModifiedByUserId VARCHAR(36) NULL, IsDeleted TINYINT(1) NOT NULL DEFAULT 0, DeletedAt DATETIME(6) NULL, CONSTRAINT FK_MediationLogs_Cases_CaseId FOREIGN KEY (CaseId) REFERENCES Cases (Id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"); } catch { }
                try { await context.Database.ExecuteSqlRawAsync(@"CREATE TABLE IF NOT EXISTS QualityAssuranceReviews (Id VARCHAR(36) NOT NULL PRIMARY KEY, CaseId VARCHAR(36) NOT NULL, AccuracyVerified TINYINT(1) NOT NULL DEFAULT 1, ConsistencyVerified TINYINT(1) NOT NULL DEFAULT 1, LegalComplianceVerified TINYINT(1) NOT NULL DEFAULT 1, PolicyAdherenceVerified TINYINT(1) NOT NULL DEFAULT 1, IsApprovedForDecision TINYINT(1) NOT NULL DEFAULT 1, QaComments TEXT NOT NULL, RevisionInstructions TEXT NULL, ReviewedByUserId VARCHAR(36) NOT NULL, ReviewedAt DATETIME(6) NOT NULL, CreatedAt DATETIME(6) NOT NULL, LastModifiedAt DATETIME(6) NULL, CreatedByUserId VARCHAR(36) NULL, LastModifiedByUserId VARCHAR(36) NULL, IsDeleted TINYINT(1) NOT NULL DEFAULT 0, DeletedAt DATETIME(6) NULL, CONSTRAINT FK_QualityAssuranceReviews_Cases_CaseId FOREIGN KEY (CaseId) REFERENCES Cases (Id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"); } catch { }
                try { await context.Database.ExecuteSqlRawAsync(@"CREATE TABLE IF NOT EXISTS CaseDecisions (Id VARCHAR(36) NOT NULL PRIMARY KEY, CaseId VARCHAR(36) NOT NULL, DecisionSummary TEXT NOT NULL, LegalBasisCitations TEXT NOT NULL, RecommendationsApproved TEXT NOT NULL, DecisionDocumentUrl VARCHAR(500) NULL, IssuedByUserId VARCHAR(36) NOT NULL, IssuerTitle VARCHAR(100) NOT NULL DEFAULT 'Chief Executive', IssuedAt DATETIME(6) NOT NULL, CreatedAt DATETIME(6) NOT NULL, LastModifiedAt DATETIME(6) NULL, CreatedByUserId VARCHAR(36) NULL, LastModifiedByUserId VARCHAR(36) NULL, IsDeleted TINYINT(1) NOT NULL DEFAULT 0, DeletedAt DATETIME(6) NULL, CONSTRAINT FK_CaseDecisions_Cases_CaseId FOREIGN KEY (CaseId) REFERENCES Cases (Id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"); } catch { }
                try { await context.Database.ExecuteSqlRawAsync(@"CREATE TABLE IF NOT EXISTS CallCenterRecords (Id VARCHAR(36) NOT NULL PRIMARY KEY, ComplaintId VARCHAR(36) NOT NULL, CallerName VARCHAR(256) NOT NULL, CallerPhoneNumber VARCHAR(100) NOT NULL, HotlineLineUsed VARCHAR(100) NOT NULL, DurationSeconds INT NOT NULL DEFAULT 180, RecordingFileUrl VARCHAR(500) NULL, CallSummary TEXT NOT NULL, LoggedByAgentId VARCHAR(36) NOT NULL, LoggedAt DATETIME(6) NOT NULL, CreatedAt DATETIME(6) NOT NULL, LastModifiedAt DATETIME(6) NULL, CreatedByUserId VARCHAR(36) NULL, LastModifiedByUserId VARCHAR(36) NULL, IsDeleted TINYINT(1) NOT NULL DEFAULT 0, DeletedAt DATETIME(6) NULL, CONSTRAINT FK_CallCenterRecords_Complaints_ComplaintId FOREIGN KEY (ComplaintId) REFERENCES Complaints (Id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"); } catch { }
            }
            else
            {
