!(function () {
    ...
    function i() {
        ...
        !t ||
            ...
            (e = (e = "/" == location.pathname ? "index.html" : location.pathname.substring(1)).substring(
                e.lastIndexOf("/") + 1
            )) &&
            ...
            Array.from(document.querySelector("#two-column-menu ul").querySelectorAll("li a")).forEach(function (a) {
                var n = (n = "/" == location.pathname ? "index.html" : location.pathname.substring(1)).substring(
                    n.lastIndexOf("/") + 1
                );
            ...
            "horizontal" !== document.documentElement.getAttribute("data-layout") &&
                ((t = new SimpleBar(document.getElementById("navbar-nav"))) && t.getContentElement(),
                ...
                (e < 1025 && 767 < e
                    ...
                    : 1025 <= e
                      ...
                      : e <= 767 &&
                        ...
                        "twocolumn" == sessionStorage.getItem("data-layout") &&
                            (document.documentElement.setAttribute("data-layout", "vertical"), y("vertical"), s()),
    ...
    function e(e) {
        if (e == e) {
            ...
            switch (e["data-theme-colors"]) {
                case "deep-blue":
                    T("data-theme-colors", "deep-blue"),
                        sessionStorage.setItem("data-theme-colors", "deep-blue"),
                        document.documentElement.setAttribute("data-theme-colors", "deep-blue");
                    break;
                case "green":
                ...
                case "blue":
                    ...
                    break;
                case "red":
                    T("data-theme-colors", "red"),
                        sessionStorage.setItem("data-theme-colors", "red"),
                        document.documentElement.setAttribute("data-theme-colors", "red");
                    break;
                default:
                    T("data-theme-colors", "green"),
                        sessionStorage.setItem("data-theme-colors", "green"),
    ...
    function T(n, e) {
        Array.from(document.querySelectorAll("input[name=" + n + "]")).forEach(function (a) {
                    ...
                    "semibox" == document.documentElement.getAttribute("data-layout") &&
                        ...
                        "data-preloader" == n && "enable" == a.value
                            ...
                            : "data-preloader" == n &&
                              ...
                              (document.documentElement.setAttribute("data-preloader", "disable"),
                              document.getElementById("customizerclose-btn").click()),
                        ("data-bs-theme" != n && "data-theme" != n && "data-theme-colors" != n) ||
            ...
            document.querySelectorAll("[data-bs-target='#collapseBgGradient.show']") &&
                Array.from(document.querySelectorAll("[data-bs-target='#collapseBgGradient.show']")).forEach(
                    function (e) {
                        e.addEventListener("click", function () {
    ...
    sessionStorage.getItem("defaultAttribute")
        ...
        : ((L = document.documentElement.attributes),
          ...
          Array.from(L).forEach(function (e) {
              ...
              e &&
                  ...
                  ((t = e.nodeName), (h[t] = e.nodeValue), sessionStorage.setItem(t, e.nodeValue));
          }),
                    ...
                    ? (v.classList.add("show"),
                      ...
                      Array.from(t).forEach(function (e) {
                          var t,
                              ...
                              n = "";
                          e.querySelector("h6")
                              ? ((t = e.getElementsByTagName("span")[0].innerText.toLowerCase()),
                                (n = (a = e.querySelector("h6").innerText.toLowerCase()).includes(o) ? a : t))
                              : e.getElementsByTagName("span") &&
                                (n = e.getElementsByTagName("span")[0].innerText.toLowerCase()),
        ...
        (z = document.querySelectorAll(".light-dark-mode")) &&
            ...
            z[0].addEventListener("click", function (e) {
                k.hasAttribute("data-bs-theme") && "dark" == k.getAttribute("data-bs-theme")
        ...
        document.getElementsByClassName("dropdown-item-cart") &&
            ...
            Array.from(document.querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn")).forEach(
                function (e) {
                    e.addEventListener("click", function (e) {
                        B--,
                            ...
                            document.getElementById("empty-cart") &&
                                (document.getElementById("empty-cart").style.display = 0 == B ? "block" : "none"),
                            document.getElementById("checkout-elem") &&
                                (document.getElementById("checkout-elem").style.display = 0 == B ? "none" : "block");
                    });
                }
            ),
            Array.from(document.getElementsByClassName("cartitem-badge")).forEach(function (e) {
        ...
        Array.from(z).forEach(function (e) {
            ...
            "flatpickr" == e.getAttribute("data-provider")
                ? ((n = e.attributes),
                  ...
                  n["data-enable-time"] &&
                      ((t.enableTime = !0), (t.dateFormat = n["data-date-format"].value.toString() + " H:i")),
                  ...
                  n["data-multiple-date"] &&
                      ((t.mode = "multiple"), (t.dateFormat = n["data-date-format"].value.toString())),
                  ...
                  n["data-inline-date"] &&
                      ...
                      (t.dateFormat = n["data-date-format"].value.toString())),
                  n["data-disable-date"] &&
                      ((a = []).push(n["data-disable-date"].value), (t.disable = a.toString().split(","))),
